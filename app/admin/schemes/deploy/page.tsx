...
import {
  FileText, ArrowLeft, Loader2, Sparkles, CheckCircle2, ChevronRight,
  ChevronLeft, Upload, Bot, ShieldCheck, MapPin, Phone, Globe, Building2,
  Calendar, Layers, DollarSign, HelpCircle, Eye, Share2, Bookmark,
...
export default function DeploySchemePage() {
  ...
  const handleSave = async (isDraft = false) => {
    ...
    try {
      ...
      // Save into central scheme-store
      saveScheme(payload)

      // Call API endpoint as backup
      try {
